...
xlsx_path = "data/ab_testing_data.xlsx"

# Upload local XLSX file to Gemini's file storage
print(f"Uploading {xlsx_path}...")
uploaded_file = client.files.upload(file=xlsx_path)
...
# Create content with uploaded file reference
prompt = f"""
Analyze the A/B testing data from the uploaded XLSX file.
...
- bounce_rate: Bounce rate (0-1 scale)
- page_views: Number of pages viewed

IMPORTANT: The file is in XLSX format (Microsoft Excel), not CSV.
Use pandas with the openpyxl or xlrd engine to read the file.
...
print("\nRunning Gemini Code Execution analysis with XLSX file...")
print("=" * 60)
...
raw_output_dir = "data/raw_xls_output"
